...
<style>
  ...
  .st-A { color: var(--vscode-gitDecoration-addedResourceForeground,     #81b88b); }
  .st-D { color: var(--vscode-gitDecoration-deletedResourceForeground,   #c74e39); }
  .st-U { color: var(--vscode-gitDecoration-untrackedResourceForeground, #73c991); }
  ...
  .file-name.st-M { color: var(--vscode-gitDecoration-modifiedResourceForeground,  #e2c08d); }
  .file-name.st-A { color: var(--vscode-gitDecoration-addedResourceForeground,     #81b88b); }
  .file-name.st-D { color: var(--vscode-gitDecoration-deletedResourceForeground,   #c74e39); }
  .file-name.st-U { color: var(--vscode-gitDecoration-untrackedResourceForeground, #73c991); }
