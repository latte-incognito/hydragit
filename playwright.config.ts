...
const DEDICATED_SPECS = /graph-perf\.spec\.ts|graph-fork\d+\.spec\.ts|conflict\.spec\.ts|journeys-dirty\.spec\.ts|safety-settings\.spec\.ts/;
...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "vscode-dirty",
      testMatch: /journeys-dirty\.spec\.ts|safety-settings\.spec\.ts/,
      use: {
        extensionPath: EXTENSION_DIR,
